      ...
      <table width="100%" cellspacing="0" cellpadding="0">
        ...
        <td colspan="1" align="left" width="38%">
          ...
          <td colspan="2" align="left" width="50%">
            <h2>ଋଣ ମଞ୍ଜୁରୀ ପତ୍ର ଏବଂ ଋଣ ଚୁକ୍ତି </h2>
          </td>
        ...
        <tr>
          <td colspan="4">
            <table width="100%" cellspacing="0" cellpadding="3">
              <tr>
                <td colspan="4" align="center"><h3>ଋଣ ମଞ୍ଜୁରୀ ପତ୍ର</h3></td>
              </tr>
              <tr>

                <td> ଆପଣଙ୍କର ଆବେଦନପତ୍ର ଦ୍ବାରା ଅନୁରୋଧ ଅନୁଯାୟୀ, ଆମ୍ଭେ ଆରୋହଣ ନିମ୍ନଲିଖିତ ଗ୍ରାହକଙ୍କ ପାଇଁ ଋଣର ସ୍ବୀକୃତି ପ୍ରଦାନ
                  କରୁଛୁ।</td>
              </tr>
            </table>
          </td>
        ...
        <tr>
          <td colspan="3" align="center" style="padding-bottom:3px;"><h3>ଗୋଷ୍ଠିର ଯୌଥ ବାଧ୍ୟବାଧକତା ସୁନିଶ୍ଚିତକରଣ ଚୁକ୍ତି</h3></td>
        </tr>
        
        <tr>
          <td colspan="3" align="left" style="padding-bottom:5px;">
            <p>ଉକ୍ତ ଚୁକ୍ତିଟି ଆରୋହଣ ଫାଇନାନସିୟାଲ ସର୍ଭିସେସ ପ୍ରା. ଲି., କମ୍ପାନୀ ଧାରା 1956, ଅଧୀନରେ ରେଜିଷ୍ଟ୍ରିଭୁକ୍ତ ଏକ ଅଣ
              ବ୍ୟାଙ୍କିଙ୍ଗ୍ ସଂସ୍ଥା, ଯାହାର ରେଜିଷ୍ଟାର୍ଡ ମୁଖ୍ୟ କାର୍ଯ୍ୟାଳୟ 4ମ ତଳ, ପିଟିଆଇ ବିଲ୍ଡିଂ, ଡିପି-9, ସେକ୍ଟର-5, ସଲ୍ଟ ଲେକ,
              କୋଲକାତା – 700091 ଅବସ୍ଥିତ ଏବଂ..................................................ର
              ମଧ୍ୟରେ...........{!! (($detailVal->dt_disbursement_date != '')?date('d', strtotime($detailVal->dt_disbursement_date)):'') !!}............. (ଦିନ)..................{!! (($detailVal->dt_disbursement_date != '')?date('F', strtotime($detailVal->dt_disbursement_date)):'') !!}.....................(ମାସ),
              ...........{!! (($detailVal->dt_disbursement_date != '')?date('Y', strtotime($detailVal->dt_disbursement_date)):'') !!}..............ତାରିଖରେ କରା ହୋଇଛି । ସମବେତ ଭାବରେ ‘’ଋଣଗ୍ରହିତା’’ ଉଲ୍ଲେଖ କରୁଛନ୍ତି ଯେ, ଋଣ
              ଗ୍ରହିତାମାନେ ତାଙ୍କ ଦ୍ବାରା............{{$detailVal->s_loan_tenure}}............ସାପ୍ତାହିକ/ପାକ୍ଷିକ/ମାସିକ କିସ୍ତିରେ, ଅର୍ଥରାଶି ହ୍ରାସ କରିବା
              ଉପରେ ଗଣନା କରାଯାଉଥିବା.........{!! json_decode(str_replace('\"', '"', $detailVal->s_product_details), true)['d_interest_rate'] !!}.........% ସୁଧ ହାରରେ ଗୃହୀତ ଋଣ ସମୟ ମଧ୍ୟରେ ପରିଶୋଧ କରିବେ ବୋଲି ପ୍ରତିଶ୍ରୁତି
              ଦେଇଛନ୍ତି। ପ୍ରତ୍ୟେକ କିସ୍ତି ମାସର............{{getCenterDetailsFronCode($detailVal->s_center_code)->i_week_of_the_month}}{{ ((getCenterDetailsFronCode($detailVal->s_center_code)->i_week_of_the_month == '1')?'st':((getCenterDetailsFronCode($detailVal->s_center_code)->i_week_of_the_month == '2')?'nd':((getCenterDetailsFronCode($detailVal->s_center_code)->i_week_of_the_month == '3')?'rd':'th')))}}............ସପ୍ତାହର............{{config('constants.MASTER_WEEK_DAYS')[getCenterDetailsFronCode($detailVal->s_center_code)->i_day_of_the_week]}}............ (ଦିନରେ) ବକେୟା ରହିବ
              ଏବଂ ପରିଶୋଧ କରିବା ପ୍ରଥମ ନିର୍ଦ୍ଦିଷ୍ଟ ତାରିଖ ହେଲା........................ (ତାରିଖ) । ବିଶଦ ଭାବରେ ପରିଶୋଧ କରିବାର
              ସମୟସୂଚୀ ଏବଂ ଉତ୍ତର ଋଣର ପ୍ରାସଙ୍ଗିକ ନିୟମ ଓ ସର୍ତ୍ତାବଳୀ, ପ୍ରତ୍ୟେକଟି ଋଣଗ୍ରହିତା ଦ୍ବାରା ପ୍ରାପ୍ତ ଋଣ ପରିଶୋଧ
              ପୁସ୍ତିକାରେ ଉଲ୍ଲେଖିତ ରହି ଅଛି ।</p>
          </td>
        </tr>
        
        <tr>
          <td colspan="3" style="font-size: 7pt; padding-bottom:5px;"><h3>ଏହି ଗ୍ରୁପର ଋଣଗ୍ରହିତାମାନେ ସୁନିଶ୍ଚିତ କରିଛନ୍ତି ଯେ:</h3>
            <ol>
              <li>ହି ଜେଏଲଜି ଗ୍ରୁପର ସଦସ୍ୟମାନଙ୍କୁ ସଦସ୍ୟମମାନେ ନିଜେ ବାଛି ନେଇଛନ୍ତି ଏବଂ ଆରୋହଣ କୌଣସି ଭାବରେ ପ୍ରଭାବିତ କରି ନାହିଁ ।</li>
              <li>ଆରୋହଣ ବକେୟା ରାଶୀ ସମ୍ବନ୍ଧିତ କୌଣସି ପରିଶୋଧର ବ୍ୟର୍ଥ ହେଲେ, ଏହି ଗ୍ରୁପଟି ଉକ୍ତ ବ୍ୟକ୍ତିକୁ ପରିଶୋଧ ଏବଂ/ବା ତା ଠାରୁ ବକେୟା ଅର୍ଥରାଶି ଆଦାୟ କରିବା ପାଇଁ ସାହାଯ୍ୟ ଓ ସହଯୋଗ କରିବେ ବୋଲି ଚୁକ୍ତିବଦ୍ଧ ଅଛନ୍ତି ।</li>
              <li>ଏହାଦ୍ବାରା ସ୍ବୀକୃତି ଦେଉଛନ୍ତି ଯେ ଗ୍ରୁପର କୌଣସି ସଦସ୍ୟ ଋଣ ପରିଶୋଧରେ ଖିଲାପ ହୋଇଥିବା ଯୋଗୁଁ ଉତ୍ପନ୍ନ ବାଧ୍ୟବାଧକତାର ଦାୟିତ୍ବ ବହନ କରିବେ।</li>
              <li>ସ୍ବୀକୃତି ପ୍ରଦାନ କରୁଛନ୍ତି ଯେ ଗ୍ରୁପର କୌଣସି ବ୍ୟକ୍ତିର ଋଣ ପପରିଶୋଧ କରିବାରେ ବ୍ୟର୍ଥ ହେଲେ ଗ୍ରୁପର ସମସ୍ତ ସଦସ୍ୟ ଆରୋହଣରୁ ଭବିଷ୍ୟତରେ କୌଣସି ଋଣ ପାଇବାକୁ ଅଯୋଗ୍ୟ ବିବେଚିତ ହେବେ।</li>
              <li>ଏହାଦ୍ବାରା ସ୍ବୀକୃତି ପ୍ରଦାନ କରୁଛନ୍ତି ଯେ ସଂଘର କୌଣସି ସଦସ୍ୟ ଋଣ ପରିଶୋଧ କରିବାରେ ବ୍ୟର୍ଥ ହୋଇଥିବା ଯୋଗୁଁ ଉତ୍ପନ୍ନ ବାଧ୍ୟବାଧକତାର ଦାୟିତ୍ବ ଗ୍ରହଣ କରିବେ।</li>
              <li>ସ୍ବୀକୃତ ହେଉଛନ୍ତି ଯେ ସଂଘ ମଧ୍ୟରେ କୌଣସି ବ୍ୟକ୍ତି ଋଣ ପରିଶୋଧ କରିବାରେ ବ୍ୟର୍ଥ ହେଲେ ଋଣ ଗ୍ରହିତାମାନେ ଆରୋହଣରୁ ଭବିଷ୍ୟତରେ କୌଣସି ଋଣ ପାଇବା ପାଇଁ ଅଯୋଗ୍ୟ ବିବେଚିତ ହେବେ।</li>
              <li>ଏବଂ ଋଣଗ୍ରହିତା ସୁନିଶ୍ଚିତ କରିଛନ୍ତି ଯେ ଋଣ ଗ୍ରହିତା ଆବେଦନ ପତ୍ରରେ ଉଲ୍ଲେଖିତ କାର୍ଯ୍ୟ ପାଇଁ ଋଣଟି ଦେଉଛନ୍ତି ଏବଂ ପ୍ରତିଶ୍ରୁତି ଦେଉଛନ୍ତି ଯେ ଆରୋହଣ ଗୃହୀତ ଋଣର ଅର୍ଥରାଶି ଅନ୍ୟ କାହାରିକୁ ଦେବେ ନାହିଁ ବା ଅପବ୍ୟବହାର କରିବେ ନାହିଁ।</li>
        ...
        <tr>
          <td colspan="3" style="font-size: 7pt; padding-bottom:5px;"><h3>ଦୁଇ ପକ୍ଷ ଆହୁରି ସ୍ବୀକୃତି ପ୍ରଦାନ କରୁଛନ୍ତି ଯେ: </h3>
            <ol>
              ...
              <li>14.	ଋଣ ସମ୍ବନ୍ଧିତ ଯେ କୌଣସି ବିବାଦ କ୍ଷେତ୍ରରେ, ଯାହା ବର୍ତ୍ତମାନ ହେଉ ବା ପରେ, କୋଲକାତା ଆଦାଲତରେ ଏହା ବିଚାର କରା  ହେବ। ଏଙା ଫଳରେ, ଯେ କୌଣସି ସକ୍ଷମ ଅଧିକାର ସୀମିତ ନୁହେଁ।</li>
            </ol>
          </td>
        </tr>

        <tr>
          <td colspan="3" style="font-size: 6pt; padding-bottom:5px;"><h3>ଆରୋହଣ ଋଣଗ୍ରହିତାମାନଙ୍କୁ ସୁନିଶ୍ଚିତ କରୁଛି ଯେ:</h3>
            <ol>
        ...
        <tr>
          <td align="left" colspan="2" style="font-size: 6pt;">
            <p>ଆରବିଆଇ ରେଜିଷ୍ଟ୍ରେସନ ନଂ: B.05.02932CIN: U74140WB1991PLC053189</p>
          </td>
