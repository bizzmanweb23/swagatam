      ...
      <table width="100%" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td colspan="2" align="left" width="50%">
            <h2>ऋण मंजूरी पत्र एवं ऋण करार</h2>
          </td>
        ...
        <tr>
          <td colspan="4">
            <table width="100%" cellspacing="0" cellpadding="3">
              <tr>
                <td colspan="4" align="center"><strong>ऋण मंजूरी पत्र</strong></td>
              </tr>
              <tr>

                <td>आपके ऋण आवेदन द्वारा अनुरोध के अनुसार, हम आरोहण निम्नलिखित ग्राहकों के लिए ऋण की स्वीकृति प्रदान
                  करते है</td>
              </tr>
            </table>
          </td>
        ...
        <tr>
          <td colspan="4" align="center" style="padding-bottom:3px;"><h3>दल के द्वारा संयुक्त उत्तरदायित्व की पुष्टि का सहमति पत्र</h3></td>
        </tr>
        
        <tr>
          <td colspan="4" align="left" style="padding-bottom:5px;">
            <p >
                यह समझौता पत्र आरोहण फाइनैंसियल सर्विसेस प्रा. लि., (यहाँ आरोहण के रूप में संदर्भित) कम्पनीज़ एक्ट, 1956 के अधीन पंजीकृत एक नॉन-बैंकिंग फाइनैंस कम्पनी, जिसका पंजीकृत कार्यालय 4थी मंज़िल, पीटीआई बिल्डिंग, डीपी-9, सेक्टर-5, सॉल्ट लेक, कोलकाता - 700091 में स्थित है एवं उपरोक्त के बीच ..............{!! (($detailVal->dt_disbursement_date != '')?date('d', strtotime($detailVal->dt_disbursement_date)):'') !!}........... (दिनांक)........{!! (($detailVal->dt_disbursement_date != '')?date('F', strtotime($detailVal->dt_disbursement_date)):'') !!}.......(माह), ......{!! (($detailVal->dt_disbursement_date != '')?date('Y', strtotime($detailVal->dt_disbursement_date)):'') !!}......को किया गया है। ‘ऋणकर्ता’ के रूप में संदर्भित । सामूहिक रूप से ‘ऋणकर्ता’ के रूप में संदर्भित
                एतत द्वारा ऋणकर्त्ता अपने द्वारा लिए गए ऋण जिसका ब्याज दर..........{!! json_decode(str_replace('\"', '"', $detailVal->s_product_details), true)['d_interest_rate'] !!}.........% है एवं जो ह्रासमान शेष पर ब्याज कि गणना विधी से..........{{$detailVal->s_loan_tenure}}...........साताहिक/पाक्षिक/मासिक किस्त समयानुसार चुकाने का वचन देता/देती हैं। सभी मासिक किस्त प्रत्येक माह के .........{{getCenterDetailsFronCode($detailVal->s_center_code)->i_week_of_the_month}}{{ ((getCenterDetailsFronCode($detailVal->s_center_code)->i_week_of_the_month == '1')?'st':((getCenterDetailsFronCode($detailVal->s_center_code)->i_week_of_the_month == '2')?'nd':((getCenterDetailsFronCode($detailVal->s_center_code)->i_week_of_the_month == '3')?'rd':'th')))}}.........सप्ताह के............{{config('constants.MASTER_WEEK_DAYS')[getCenterDetailsFronCode($detailVal->s_center_code)->i_day_of_the_week]}}..........(दिन) को देय है एवं जिसकी प्रथम किस्त का भुगतान.................(तारीख) को देय है। विस्तृत भुगतान तालिका एवं ऋण से संबंधित नियम एवं शर्तें, प्रत्येक ऋणकर्ता को प्रदान की गई ऋण भुगतान पुस्तिका में उल्लेखित है। विस्तृत भुगतान तालिका एवं ऋण से संबंधित नियम एवं शर्तें, प्रत्येक ऋणकर्ता को प्रदान की गई ऋण भुगतान पुस्तिका में उल्लेखित है।
        ...
        <tr>
          <td colspan="3" style="font-size: 7pt; padding-bottom:5px;"><h3>इस दल के ऋणकर्ता सुनिश्चित करते हैं कि:</h3>
            <ol>
              <li>जेएलजी दल के सदस्यों का चुनाव सदस्यों द्वारा ही किया गया है एवं आरोहण के प्रभाव में नहीं.</li>
              <li>आरोहण के पास बकाया पेमेंट संबंधित किसी भी भुगतान में असफल होने पर, यह दल कथित व्यक्ति का निषेध करेगा एवं/या उनके पास से बकाया राशि वसूल करने में आरोहण की साहयता करेगा।</li>
              <li>एतद्वारा सुनिश्चित किया जाता है कि दल के किसी भी सदस्य के ऋण के भुगतान में असफल होने के कारण दल उत्पन्न देयधन की ज़िम्मेदारी लेंगे।</li>
              <li>सुनिश्चितत करते हैं कि दल का कोई भी व्यक्ति ऋण के भुगतान में असफल होने पर दल के सभी सदस्य भविष्य में आरोहण से किसी भी प्रकार के ऋण के लिए अयोग्य होे जाएंगे।</li>
              <li>सुनिश्चित किया जाता है कि सेंटर के किसी भी सदस्य के ऋण भुगतान में असफल होने के कारण उत्पन्न देयधन की ज़िम्मेदारी लेंगे।</li>
        ...
        <tr>
          <td colspan="3" style="font-size: 7pt; padding-bottom:5px;"><h3>दोनों पार्टी यह भी स्वीकृत करती है कि:</h3>
            <ol>
              ...
              <li>ऋणकर्ता(गण) के द्वारा समय से पहले ऋण का भुगतान करने पर कोई भी जुर्माना चार्ज नहीं लिया जाएगा।</li>
        ...
        <tr>
          <td colspan="3" style="font-size: 7pt; padding-bottom:5px;"><h3>आरोहण ऋणकर्ता को आश्वस्त करता है कि :</h3>
            <ol>
              ...
              <li>3्राहकों को बीमा सेवा प्रदान करने के लिए बीमा प्रदानकारी या तृतीय पक्ष प्रदानकारियों को ग्राहक की जानकारी दी जाएगी।</li>
        ...
        <tr>
          <td align="left" colspan="2" style="font-size: 6pt;">
            <p>आरबीआई रजिस्ट्रेशन नंबर : B.05.02932CIN: U74140WB1991PLC053189</p>
          </td>
