      ...
      <table width="100%" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td colspan="2" align="left" width="50%">
            <h2>ঋণ মংজুরী পত্র এবং ঋণ চুক্তি</h2>
          </td>
        ...
        <tr>
          <td colspan="4">
            <table width="100%" cellspacing="0" cellpadding="3">
              <tr>
                <td colspan="4" align="center"><h3>ঋণ মঁজুরী পত্র</h3></td>
              </tr>
              <tr>

                <td style="font-family: 'bang', sans-serif;"> আপনার আবেদনপত্রের দ্বারা অনুরোধের অনুযায়ী, আমরা আরোহণ নিম্নলিখিত গ্রাহকদের জন্য ঋণের স্বীকৃতি
                  প্রদান করছি।</td>
              </tr>
            </table>
          </td>
        ...
        <tr>
          <td colspan="4" style="padding-bottom:10px;">
            <table width="100%" cellspacing="0" cellpadding="4" style="border-top: 1px solid #dddddd; border-left: 1px solid #dddddd;">
              <thead>
                <tr>
        ...
        <tr>
          <td colspan="4" align="center" style="padding-bottom:3px;" ><h3>গ্রুপের যৌথ দায়বদ্ধতার সমতির চুক্তি</h3></td>
        </tr>
        
        <tr>
          <td colspan="4" align="left" style="padding-bottom:5px;">এই ঋণ চুক্তিটি ...{!! (($detailVal->dt_disbursement_date != '')?date('Y', strtotime($detailVal->dt_disbursement_date)):'') !!}....সালের....{!! (($detailVal->dt_disbursement_date != '')?date('F', strtotime($detailVal->dt_disbursement_date)):'') !!}....মাসের....{!! (($detailVal->dt_disbursement_date != '')?date('d', strtotime($detailVal->dt_disbursement_date)):'') !!}......তারিখে, আরোহণ ফিনান্সিয়াল
            সার্ভিসেস প্রাইভেট লিমিটেড, (এখানে আরোহণ হিসেবে উল্লেখিত) কোম্পানি আইন-১৯৫৬ দ্বারা নিবন্ধীকৃত একটি নন
            ব্যাঙ্কিং ফিনান্স কোম্পানী, যার রেজিস্টার্ড অফিস-৪র্থ তলা, পি.টি.আই. বিল্ডিং, ডি.পি. ব্লক, ডিপি-৯, সেক্টর-৫,
            সল্টলেক, কোলকাতা-৭০০০৯১। সম্মিলিতভাবে 'ঋণগ্রহিতা'-এই দুই পক্ষের মধ্যে সম্পন্ন হল।
            <br>ঋণগ্রহিতারা তাঁদের দ্বারা গৃহীত ঋণ শতকরা......{!! json_decode(str_replace('\"', '"', $detailVal->s_product_details), true)['d_interest_rate'] !!}......% সুদের হারে (ক্রমহ্রাসমান)......{{$detailVal->s_loan_tenure}}.......টি
            সাপ্তাহিক/পাক্ষিক/মাসিক নিয়মিতভাবে সঠিক সময়ে পরিশোধ করবেন বলে প্রতিশ্রুতি দিচ্ছেন। প্রতিটি কিস্তি জমা দেওয়ার
            নির্দিষ্ট দিন প্রতি মাসের.......{{getCenterDetailsFronCode($detailVal->s_center_code)->i_week_of_the_month}}{{ ((getCenterDetailsFronCode($detailVal->s_center_code)->i_week_of_the_month == '1')?'st':((getCenterDetailsFronCode($detailVal->s_center_code)->i_week_of_the_month == '2')?'nd':((getCenterDetailsFronCode($detailVal->s_center_code)->i_week_of_the_month == '3')?'rd':'th')))}}.......সপ্তাহের.......{{config('constants.MASTER_WEEK_DAYS')[getCenterDetailsFronCode($detailVal->s_center_code)->i_day_of_the_week]}}.......(বার), এবং প্রথম কিস্তি জমা দেওয়ার নির্দিষ্ট
            তারিখ হল............ (তারিখ)। ঋণগ্রহিতারা তাঁদের দ্বারা প্রাপ্ত লোন রিপেমেন্ট কার্ডে ঋণ পরিশোধের সময়সূচী এবং
            ঋণ সংক্রান্ত নিয়ম ও শর্তাবলী বিস্তারিতভাবে উল্লেখিত আছে। </td>
        </tr>
        
        <tr>
          <td colspan="4" style="font-size: 7pt;  padding-bottom:5px; "><h3>সম্মিলিতভাবে গ্রুপের ঋণগ্রহিতারা সুনিশ্চিত করছেন যে : </h3>
            <ol>
              <li>এই জেএলজি গ্রুপের সদস্যদেরকে সদস্যরা নিজেরাই বেছে নিয়েছেন এবং আরোহণ কোনওভাবে প্রভাবিত করে নি।</li>
              <li>আরোহণের বকেয়া কিস্তি পরিশোধের ক্ষেত্রে সেন্টারের কোনও সদস্য/সদস্যা ব্যর্থ হলে, গ্রুপের সদস্য/সদস্যা
                হিসেবে এই অবস্থাকে প্রতিরোধ করবেন এবং উক্ত ব্যক্তির কাছ থেকে বকেয়া কিস্তি আদায় করার জন্য আরোহণের সঙ্গে
                সবরকম সহযোগিতা করবেন।</li>
              <li>গ্রুপের কোনও সদস্য/সদস্যা ঋণ পরিশোধে ব্যর্থ হলে তার দায়ভার গ্রহণ করবেন।</li>
              <li>গ্রুপের কোনও ব্যক্তি ঋণ পরিশোধে ব্যর্থ হলে, গ্রুপের সমস্ত সদস্য/সদস্যা ভবিষ্যতে আরোহণের থেকে কোনও ঋণ
                পাওয়ার জন্য অযোগ্য বিবেচিত হতে পারেন।</li>
              <li>সেন্টারের কোনও সদস্য/সদস্যা ঋণ পরিশোধে ব্যর্থ হলে তার দায়ভার গ্রহণ করবেন।</li>
              <li>সেন্টরের কোনও ব্যক্তি ঋণ পরিশোধে ব্যর্থ হলে, ঋণগ্রহিতারা ভবিষ্যতে আরোহণের থেকে কোনও ঋণ পাওযার জন্য
                অযোগ্য বিবেচিত হতে পারেন।</li>
              <li>ঋণগ্রহিতারা প্রত্যেকে নিজেদের জন্য ঋণটি নিচ্ছেন এবং ঋণের আবেদনপত্রে উল্লিখিত কাজের জন্য ব্যবহার করবেন,
                এবং প্রতিশ্রুতি দিচ্ছেন যে আরোহণের থেকে গৃহীত ঋণের অর্থরাশি অন্যকে দেবেন না বা অপব্যবহার করবেন না।</li>
              <li>ঋণগ্রহিতারা আরোহণে একটির বেশী গ্রুপের সদস্য/সদস্যা হতে পারবেন না।</li>
            </ol>
          </td>
        </tr>
        
        <tr>
          <td colspan="4" style="font-size: 7pt; padding-bottom:5px; "><h3>উভয়পক্ষ আরও স্বীকৃতি জানাচ্ছেন যে,</h3>
            <ol>
              <li value="1">লোন দেওয়ার তারিখ থেকে সুদ ধার্য করা হবে এবং দৈনিক ভিত্তিতে সুদ জমা হবে।</li>
              <li>{!! json_decode(str_replace('\"', '"', $detailVal->s_product_details), true)['d_lpf'] !!}% লোন প্রসেসিং ফি এবং প্রযোজ্য কর ও প্রতি বছরে প্রতি হাজার টাকার উপর {!! number_format($detailVal->d_ins_fee, 2, '.', ',') !!} টাকার বীমা প্রিমিয়াম এবং
                প্রযোজ্য কর গ্রাহককে প্রদান করতে হবে।</li>
              <li>যদি ঋণগ্রহিতা (গণ) নির্ধারিত সময়ের আগে ঋণ পরিশোধ করেন তাহলে কোনও জরিমানা ধার্য করা হবে না।</li>
              <li>এই ঋণটি প্রদানের জন্য আরোহণের দ্বারা কোনও প্রকার জামিন/সিকিউরিটি ডিপোজিট/মার্জিন টাকা নেওয়া হয় নি।
              </li>
              <li>ঋণগ্রহিতা (গণ) দ্বারা স্বাক্ষরিত ঋণ সম্পর্কিত সমস্ত নথিপত্র এই চুক্তির অবিচ্ছেদ্য অংশ।</li>
              ...
              <li>যদি কোনও দস্য/সদস্যা ঋণ পরিশোধ করতে ব্যর্থ হন, তাহলে আরোহণ ঐ ব্যক্তির ঋণ পরিশোধে ব্যর্থতার তথ্য
                ক্রেডিট ব্যুরোকে জানাবে এবং যার ফলশ্রুতি হিসেবে ঋণগ্রহিতা অনুরূপ কোনও সংস্থা থেকে ঋণ পাওয়ার ক্ষেত্রে
                অযোগ্য বিবেচিত হবেন।</li>
              ...
              <li>ঋণের মূল্য হিসেবে গ্রাহককে কেবল অফেরতযোগ্য সুদ, ঋণ প্রসেসিং চার্জ এবং ইন্স্যুরেন্স প্রিমিয়াম (প্রযোজ্য
                কর সহ) দিতে হবে। </li>
              <li>ঋণ গ্রহিতার একাধিক এমএফআই এ (স্বা-ধন অধীনস্থ) সংস্থা থেকে ঋণ থাকলে আরোহণ তাঁকে ঋণ প্রদান করবে না।
              </li>
        ...
        <tr>
          <td colspan="4" style="font-size: 7pt; padding-bottom:5px;"><h3>আরোহণ ঋণগ্রহিতাকে সুনিশ্চিত করছে যে,</h3>
            <ol>
              <li value="1"> ঋণগ্রহিতার তথ্যের গোপনীয়তাকে মর্যাদা দেওয়া হবে। কিন্তু ক্রেডিট ব্যুরো, বীমা প্রদানকারী,
                দেশের যে কোনও আইনি এনফোর্সমেন্ট এজেন্সি দ্বারা তথ্য জমা করার নির্দেশ আরোহণ পালন করবে।</li>
              <li>অতীতের ক্রেডিট ইতিহাস জানার জন্য গ্রাহকদের তথ্য ক্রেডিট ব্যুরোকে জানানো হবে।</li>
              <li>গ্রাহককে বীমা পরিষেবা প্রদান করার জন্য, বীমা প্রদানকারী বা থার্ড পার্টি প্রদানকারীকে গ্রাহকের তথ্য
                জানানো হবে</li>
              <li>রেটিং এবং সার্টিফিকিশন এজেন্সি ইত্যাদিকে তথ্য জানানোর সময়, আরোহণ সুনিশ্চিত করবে য়ে এই তথ্যগুলি
                ''শুধুমাত্র জানার জন্য'' প্রদান করা হবে এবং গ্রাহকের তথ্যের গোপনীয়তাও সুনিশ্চিত করবে। </li>
              <li>কর্মীদের অনুচিত ব্যবহার নিবারণ করা এবং সময়মতো অভিযোগের প্রতিবিধান করার জন্য আরোহণ দায়িত্বশীল থাকবে।
              </li>
        ...
        <tr>
          <td colspan="4">
            <table width="100%" colspacing="0" cellpadding="0">
              <tr>
                <td >
                <p style="padding-bottom:3px;"><strong>ঋণগ্রহিতার স্বাক্ষর :</strong></p>
                  <table  width="100%" colspacing="0" cellpadding="0">
                    <tr>
                      <td width="40%">
        ...
        <tr>
          <td colspan="3" align="center"><strong>ক্রস সেল লোনের জন্য গ্রাহকের ঘোষণা </strong></td>
        </tr>
        <tr>
          <td >&nbsp;</td>
        </tr>
        ...
        <tr>
          <td align="left" colspan="3" style="font-size: 7pt">
