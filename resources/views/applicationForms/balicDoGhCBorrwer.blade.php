        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
            ...
            <tr>
                ...
                <td align="right" style="padding-bottom: 0; padding-top: 0;">
                    ...
                    <p style="margin: 0; padding: 0; font-size: 7pt;">Bajaj Allianz House, Airport Road, Yerawada, Pune - 411006.</p>
                </td>
            </tr>
            <tr>
                <td colspan="2" style="height: 10px; width: 100%;"></td>
            ...
            <tr>
                <td valign="middle" style="padding:3px;">
                    <table width="100%" cellpadding="0" cellspacing="0" style="width:230px;">
                        <tr>
                            <td style="width:90px;"><strong style="margin:0; margin-right: 5px; line-height: 18px;width: 100px;">Master Policy No.:</strong></td>
            ...
            <tr>
                ...
                <table cellpadding="0" cellspacing="2" style="width:675px">
                    <tr>
                        <td style="width:60px;"><strong style="margin-right: 1px; line-height: 12px;font-size: 7pt; font-wight:bold;">Channel Name: </strong></td>
            ...
            <tr>
                <td colspan="2" style="padding:2px 0;">
                    <table cellpadding="0" cellspacing="4" style="width:100%;">
                        <tr>
                            <td valign="middle" style="width:100px;line-height: 15px;font-size: 7pt; font-wight:bold;"><strong >Full Name of Member:</strong></td>
                            <td style="padding-left:4px;padding-right:4px; width:280px; text-align: left; line-height: 15px; height: 15px; border: 1px solid #000; font-size: 7pt;">{{$detailVal->s_borrower_salutation}} {{$detailVal->s_borrower_name}}</td>
                            <td style="width:10px;"></td>
                            <td valign="middle" style="width:125px;"><strong style="line-height: 15px;font-size: 7pt; font-wight:bold;">Son/Daughter/Spouse of:</strong></td>
                            <td style="padding-left:4px;padding-right:4px; width:240px; text-align: left; line-height: 15px; height: 15px; border: 1px solid #000; font-size: 7pt;">{{$detailVal->s_borrower_father_or_husband_salutation.' '.$detailVal->s_borrower_father_or_husband_name}}</td>
                        </tr>
                        <tr>
                            <td colspan="5" style="padding:3px;"></td>
                        </tr>
                        <tr>
                            <td valign="middle" style="width:100px;line-height: 15px;font-size: 7pt; font-wight:bold;"><strong >Full Name of Joint Life</strong></td>
                            <td style="padding-left:4px;padding-right:4px; width:280px; text-align: center; line-height: 15px; height: 15px; border: 1px solid #000; font-size: 7pt;">NA</td>
                            <td style="width:10px;"></td>
                            <td valign="middle" style="width:125px;line-height: 15px;font-size: 7pt; font-wight:bold;"><strong>Son/Daughter/Spouse of:</strong></td>
                            <td style="padding-left:4px;padding-right:4px; width:240px; text-align: center; line-height: 15px; height: 15px; border: 1px solid #000; font-size: 7pt;">NA</td>
                        </tr>
                    </table>
                </td>
            </tr>
            ...
            <tr>
                <td colspan="2" style="padding:3px 0 ">
                    <table cellpadding="0" cellspacing="4" style="width:100%;">
                        <tr>
                            <td>
                                <table width="100%" cellpadding="0" cellspacing="0" style="width:173px;">
                                    <tr>
                                        <td style="line-height: 18px;width: 53px;"><strong style="font-size: 6pt; font-weight:bold;">Date of Birth:<strong></td>
                                        @php ($dobSplt = str_split(date('dmY',strtotime($detailVal->dt_borrower_dob))))
                                        @for($i = 0; $i < 8; $i++)
                                            @if($i == 0)
                            ...
                            <td>
                                <table width="100%" cellpadding="0" cellspacing="0" style="width:132px;">
                                    <tr>
                                        ...
                                        <td style="text-align: center; line-height: 16px; width: 50px; height: 16px; border: 1px solid #000;color:#b2b3b3;font-size: 6pt; font-weight:bold;font-family: Arial, Helvetica, sans-serif;"> 
                                        {!! ($detailVal->s_borrower_gender == 'Male')?'<img src="'.asset('public/images/male-check.png').'" alt="logo" style="width: 20px;" >':'Male' !!} </td>
                                        <td style="width:2px;">&nbsp;</td>
                                        <td style="text-align: center; line-height: 16px; width: 56px; height: 16px; border: 1px solid #000;color:#b2b3b3;font-size: 6pt; font-weight:bold;font-family: Arial, Helvetica, sans-serif;"> 
                                        {!! ($detailVal->s_borrower_gender == 'Female')?'<img src="'.asset('public/images/female-check.png').'" alt="logo" style="width: 25px;" >':'Female' !!} </td>
                                    </tr>
                                </table>
                            </td>
                            <td align="right">
                                <table width="100%" cellpadding="0" cellspacing="0" style="width:250px;">
                                    <tr>
                                        ...
                                        @php ($strSplt = ($detailVal->i_borrower_kyc_type_id != '' && $detailVal->i_borrower_kyc_type_id == '3')?str_split($detailVal->s_borrower_kyc):[])
                                        @for($i = 0; $i < 12; $i++)
                        ...
                        <tr>
                            <td>
                                <table width="100%" cellpadding="0" cellspacing="0" style="width:173px;">
                                    <tr>
                                        <td style="line-height: 18px;width: 48px;"><strong style="font-size: 6pt; font-weight:bold;">Date of Birth:<strong></td>
                            ...
                            <td>
                                <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse; width:200px">
                                    <tr>
                                        ...
                                        @php ($strSplt = ($detailVal->i_borrower_mobile_no != '')?str_split($detailVal->i_borrower_mobile_no):[])
                                        @for($i = 0; $i < 10; $i++)
                                            @if(array_key_exists($i, $strSplt))
                                                @if($i == 0)
                                                    <td style="color: #000;text-align: center;line-height: 16px;width:15px; height:15px;border-top: 1px solid #000;border-right: 1px solid #000; border-bottom: 1px solid #000; border-left:1px solid #000; float:left;">{{$strSplt[$i]}}</td>
                ...
                <td colspan="2" style="padding-top: 3px;padding-bottom:3px;">
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse;">
                        <tr>
                            ...
                            <td align="left" style="padding: 1px;border: 1px solid #000;font-size:6pt;">{{$detailVal->s_cb_customer_salutation}} {{$detailVal->s_cb_customer_name}}</td>
                        ...
                        <tr>
                            ...
                            <td style="padding: 1px; border: 1px solid #000;font-size:6pt;"  align="left">{{date('d/m/Y', strtotime($detailVal->dt_cb_dob))}}</td>
                        ...
                        <tr>
                            ...
                            <td style="padding: 1px; border: 1px solid #000;font-size:6pt;"  align="left">
                                <?php
                ...
                <td colspan="2" valign="middle" style="padding:1px;">
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse;">
                        <tr>
                            ...
                            <td style="text-align: left; line-height: 15px; width:540px; padding-left:5px; height: 15px; border: 1px solid #000; color: #000;"></td>
                        </tr>
                    </table>
                </td>
            </tr>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0" style="width:100px;">
                                    <tr>
                                        ...
                                        <td style="text-align: left; line-height: 12px; width:120px; padding-left: 1%; height: 12px; border-bottom: 1px solid #000; color: #000;"></td>
                                    </tr>
                                </table>                                
                            </td>
                            <td>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0" style="width:430px;">
                                    <tr>
                                        ...
                                        <td style="line-height: 15px; width: 260px; padding-left: 5px; height: 15px; border: 1px solid #000;color: #000;">{{($detailVal->s_loan_id == '')?'':$detailVal->s_loan_id.'S'}}</td>
                                    </tr>
                                </table>                                
                            </td>
                            <td>
                            ...
                            <td>
                                <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse;" style="width:150px">
                                    <tr>
                                        ...
                                        <td style="text-align: center; line-height: 15px;width: 38px; height: 16px; margin-right: 5px; border: 1px solid #000; color: #000; font-size: 7pt;"><img src="{{asset('public/images/lavel.png')}}" alt="lavel" style="width:20px;"></td>
                                        <td style="width:3px;"></td>
                                        <td style="text-align: center; line-height: 15px; width: 50px; height: 16px; border: 1px solid #000; color: #000; font-size: 7pt;">Reducing</td>
                                    </tr>
                                </table>                                
                            </td>
                            <td>
                                <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse;" style="width:300px">
                                    <tr>
                                        <td style="line-height: 15px;width:96px; padding-left:5px; font-size: 6pt;"><strong>Rate of Interest: </strong><span style="font-size: 7pt; line-height: 9px;">(For Reducing Cover)</span></td>
                                        <td style="text-align: center; line-height: 15px; width: 98px; height: 15px; border-bottom: 1px solid #000; color: #000; font-size: 7pt;">NA</td>
                                    </tr>
                                </table> 
                            </td>
                            <td>
                                <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse;" style="width:300px">
                                    <tr>
                                        <td style="line-height: 15px;width:95px;padding-left:5px; font-size: 6pt;"><strong>Additional Benefit/Rider/Variant (If any): </strong></td>
                                        <td style="text-align: center; line-height: 15px; width: 90px; height: 15px; border-bottom: 1px solid #000; color: #000; font-size: 7pt;">NA</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                            ...
                            <td>
                                <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse;width:290px;">
                                    <tr>
                                        ...
                                        <td style="text-align: center; line-height: 15px; height: 15px; width:40px; padding-left: 3px; padding-right: 3px; border-top: 1px solid #000; border-right: 1px solid #000; border-bottom: 1px solid #000; color: #bfbdbd; border-left: 1px solid #000;font-size: 7pt;"><img src="{{asset('public/images/Single.png')}}" alt="lavel" style="width:25px;"></td>
                                        <td style="text-align: center; line-height: 15px; height: 15px; width:40px; padding-left: 3px; padding-right: 3px; border-top: 1px solid #000; border-right: 1px solid #000; border-bottom: 1px solid #000; color: #bfbdbd; font-size: 7pt;">Yearly</td>
                                        <td style="text-align: center; line-height: 15px; height: 15px; width:40px; padding-left: 3px; padding-right: 3px; border-top: 1px solid #000; border-right: 1px solid #000; border-bottom: 1px solid #000; color: #bfbdbd; font-size: 7pt;">Half-Yearly</td>
                                        <td style="text-align: center; line-height: 15px; height: 15px; width:40px; padding-left: 3px; padding-right: 3px; border-top: 1px solid #000; border-right: 1px solid #000; border-bottom: 1px solid #000; color: #bfbdbd; font-size: 7pt;">Quarterly</td>
                                        <td style="text-align: center; line-height: 15px; height: 15px; width:40px; padding-left: 3px; padding-right: 3px; border-top: 1px solid #000; border-right: 1px solid #000; border-bottom: 1px solid #000; color: #bfbdbd; font-size: 7pt;">Monthly</td>
                                    </tr>
                                </table>
                            </td>
                            ...
                            <td align="left">
                                <table cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
                                    <tr>
                                        ...
                                        <td style="text-align: center; line-height: 15px; width: 100px; height: 15px; border: 1px solid #000; color: #000; font-size: 7pt;">NA</td>
                                    </tr>
                                </table>
                            </td>
                            <td style="width:50px;"></td>
            ...
            <tr>
                <td colspan="2" style="font-size: 7pt; line-height: 12px; padding:5px 0;">
            ...
            <tr>
                <td colspan="2" style="font-size: 7pt; line-height:12px; padding:5px;">
            ...
            <tr>
                <td colspan="2" style="font-size: 7pt; line-height: 9px; padding:3px;">
                                    ...
                                    <tr>
                                        <td>
                                            <table cellpadding="0" cellspacing="0" style="width:250px;">
                                                <tr>
                                                    <td colspan="4" style="font-size: 7pt; line-height: 9px;">Customer’s Preferred Language</td>
                                                </tr>
                                                <tr>
                                                    <td style="text-align: center; line-height: 15px; width:12px; height: 12px; border: 1px solid #000;"></td>
                                                    <td style="padding-right: 2px; padding-left: 1px; line-height: 12px; font-size: 7pt;">English</td>
                                                    <td style="text-align: center; line-height: 15px; width:12px; height: 12px; border: 1px solid #000;"></td>
                                                    <td style="padding-right: 2px; padding-left: 1px; line-height: 12px; font-size: 7pt;"> Other Language _________________</td> 
                                                </tr>
                                            </table>
                                        </td>
                                        <td>
                                            <table cellpadding="0" cellspacing="0" >
                                                <tr>
                                                    <td style="width: 170px;text-align: center; padding: 3px; line-height: 10px; border-left: 1px solid #000;  border-bottom: 1px solid #000; border-right:  1px solid #000; color: #bfbdbd; font-size: 7pt;">Signature or thumb impression</td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
            ...
            <tr>
                <td colspan="2" style="font-size: 7pt; line-height: 9px;" align="right"><!-- 26_6_2018 --></t padding:3px;d>
            </tr>
            </table>
        </article>
    </section>
