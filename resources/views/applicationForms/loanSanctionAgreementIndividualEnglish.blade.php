      ...
      <article>
          ...
          <tr>
            <td colspan="3">
              ...
              <tr>
                ...
                <tr>
                  <td> As requested by you vide your loan application we Arohan, hereby approve the below loan to</td>
                </tr>
              </table>
            </td>
          </tr>
              ...
              <table width="100%" cellspacing="0" cellpadding="4" style="border: 1px solid #dddddd">
                ...
                <thead>
                  <tr>
                    ...
                    <td colspan="4" rowspan="0" align="right" style="border-right: 1px solid #dddddd"> {!! (($detailVal->d_sanctioned_loan_amount !='')?number_format($detailVal->d_sanctioned_loan_amount, 2, '.', ','):number_format($detailVal->s_loan_amount, 2, '.', ',')) !!} </td>
                    <td colspan="4" rowspan="0" align="right" style="border-right: 1px solid #dddddd">
                    	{!! number_format((json_decode(str_replace('\"', '"', $detailVal->s_product_details), true)['lpf_amount']+json_decode(str_replace('\"', '"', $detailVal->s_product_details), true)['gst_amount']), 2, '.', ',') !!}</td>
                    <td colspan="4" rowspan="0" align="right" style="border-right: 1px solid #dddddd"> {!! number_format($detailVal->d_emi, 2, '.', ',') !!}  </td>
                    <td colspan="4" rowspan="0" align="right" style="border-right: 1px solid #dddddd">{!! number_format($detailVal->d_ins_fee, 2, '.', ',') !!}</td>
                  </tr>
                </thead>
        ...
        <tr>
          <td colspan="3" align="center" style="padding-bottom:3px;">
            <h3 class="heading-02">Agreement Affirming the Joint Liability of the Center</h3>
          </td>
        </tr>
        <tr>
          ...
          <tr>
            <td colspan="3" align="left" style="padding-bottom:3px; font-size:6pt; line-height:8pt;">
              ...
              Kolkata-700091 and above mentioned customer. Referred to as ‘Borrower’. 
            </p>
          </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="3" align="left" style="padding-bottom:3px; font-size:6pt; line-height:8pt;">
              ...
              loans taken by them at {!! json_decode(str_replace('\"', '"', $detailVal->s_product_details), true)['d_interest_rate'] !!}% rate of interest calculated on a diminishing balance in {{$detailVal->s_loan_tenure}}
              ...
              Book which the borrower acknowledges having received. 
              </p>
              </td>
          </tr>
          <tr>
        ...
        <tr>
          <td colspan="3" style="font-size: 7pt; padding-bottom:5px;">
            <h3 class="heading-02">The borrower confirms that:</h3>
          </td>
        </tr>
          <tr>
            <td colspan="3" style="padding-bottom:3px">
              <ol style="font-size:6.8pt">
                <li>Should a case of default arise with respect to the payments due, to Arohan, in the center, the
                  borrower, would assist and co-operate with Arohan to prevent and /or recover overdue amount from the
                  said person(s).</li>
                <li>Undertake to make good the liability that arises on account of any default committed by any center
                  member.</li>
                <li>Accept that, any case of default within the center, can result in the borrower being ineligible for
                  future loans from Arohan.</li>
                <li>And the borrowers undertake that the borrower is taking the loan for himself/herself to use for the
                  purpose stated in the loan application form, and promises not to either handover or misutilize the loan
                  amount taken from Arohan. </li>
                <li>The borrower cannot be a member of a JLG with Arohan. </li>
              </ol>
            </td>
          </tr>
          <tr>
        ...
        <tr>
          <td colspan="3">
            <table width="100%" colspacing="0" cellpadding="0">
              ...
              <tr>
                <td >
                <p style="padding-bottom:5px;margin-bottom:5px;font-size:6.8pt;"><strong>Signature of Borrower:</strong></p>
                  <table  width="100%" colspacing="0" cellpadding="0">
            		<tr>
                      <td width="60%">
                        <div style="margin-bottom: 10px;">1.	_________________________________________</div>                    
                      </td>
                      <td></td>
                      <td width="40%" align="center">
                        <p style="text-align: center;font-size:7pt;">For Arohan Financial Services Ltd.</p>
                      </td>
                    </tr>
                    <tr>
                      <td></td>
                    ...
                    <tr>
                      ...
                      <td></td>
                      <td align="center">                     
                        <p style="text-align: center;font-size:6.8pt;">(Signature)</p>
                      </td>
                    </tr>
                    <tr>
                      <td></td>
                    ...
                    <tr>
                      ...
                      <td></td>
                      <td align="center">
                        <p style="text-align: center;font-size:6.8pt;">(Name of Authorised Signatory)</p>
                      </td>
                    </tr>
                    <tr>
                      <td></td>
