...
<head>
  <meta charset="utf-8">
  <title>Loan Agreement cum Loan Sanction Individual Assamese</title>
  <style>
      ...
      <table width="100%" cellspacing="0" cellpadding="0">
        ...
        <td colspan="1" align="left" width="38%">
          ...
          <td colspan="2" align="left" width="50%">
            <h2 class="heading-01">ঋণ মঞ্জুৰী পত্র আৰু ঋণ চুক্তি</h2>
          </td>
        ...
        <tr>
          <td colspan="4">
            <table width="100%" cellspacing="0" cellpadding="3">
              <tr>
                <td colspan="3" align="center"><h3 class="heading-01">ঋণ মঞ্জুৰী পত্র</h3></td>
              </tr>
              <tr>

                <td>আপোনাৰ ঋণ আবেদনপত্র দ্বাৰা গৃহীত অনুৰোধ অনুয়াযী, আমি আৰোহণে নিম্নলিখিত গ্রাহকৰ নিম্নলিখিত অর্থৰাশি
                  ঋণ হিচাপে মঞ্জুৰ কৰিছো।</td>
              </tr>
            </table>
          </td>
        </tr>
        ...
        <tr>
          <td colspan="3" align="center" style="padding-bottom:3px;"><h3 class="heading-01">কৰ যু দায়বতা িনিশচত কৰা চুিপ</h3></td>
        </tr>
        <tr>
            <td colspan="3" style="padding-bottom:8px;"></td>
          </tr>
        <tr>
          <td colspan="3" align="left" style="padding-bottom:5px;">
            <p>__{!! (($detailVal->dt_disbursement_date != '')?date('Y', strtotime($detailVal->dt_disbursement_date)):'') !!}__চনৰ ______{!! (($detailVal->dt_disbursement_date != '')?date('F', strtotime($detailVal->dt_disbursement_date)):'') !!}______ মাহৰ ___{!! (($detailVal->dt_disbursement_date != '')?date('d', strtotime($detailVal->dt_disbursement_date)):'') !!}___ তাৰিখে এই চুক্তিপত্রখন প্রস্তুত কৰা হৈছে, যাৰ পক্ষবোৰ হৈছে আৰোহণ
              ...
              একেলগে যাক 'ঋণ লওতা' বুলি সমোধন কৰা হ'ব।
        ...
        <tr>
          <td colspan="3" align="left" style="padding-bottom:5px;">
            <p>ঋণ লওতা সকলে তেওঁলোকে লোৱা ঋণটো ধার্য্য হোৱা ___{!! json_decode(str_replace('\"', '"', $detailVal->s_product_details), true)['d_interest_rate'] !!}____ % হাৰৰ
              সূতত ___{{$detailVal->s_loan_tenure}}___ টা সাপ্তাহিক¡/পাক্ষিক¡/মাহিলী কিস্তিত সময়মতে পৰিশোধ কৰিব বুলি প্রতিশ্রুতি দিছে। প্রতিটো কিস্তি
              মাহৰ ___{{getCenterDetailsFronCode($detailVal->s_center_code)->i_week_of_the_month}}{{ ((getCenterDetailsFronCode($detailVal->s_center_code)->i_week_of_the_month == '1')?'st':((getCenterDetailsFronCode($detailVal->s_center_code)->i_week_of_the_month == '2')?'nd':((getCenterDetailsFronCode($detailVal->s_center_code)->i_week_of_the_month == '3')?'rd':'th')))}}___সপ্তাহৰ _____{{config('constants.MASTER_WEEK_DAYS')[getCenterDetailsFronCode($detailVal->s_center_code)->i_day_of_the_week]}}______-ত (দিন) দিযা হ'ব, আৰু প্রথম কিস্তিটোৰ দিয়া তাৰিখ হৈছে _______________
              ।বিতং পৰিশোধৰ অনুসূচী আৰু ঋণটোৰ সকলো প্রাসঙ্গিক নিযমাৱলী আৰু চর্তাৱলী ঋণ পৰিশোধ পত্রিকাত ডল্লেখ কৰা আছে য়ি
              প্রতিজন ঋণ লওতাই প্রাপ্ত কৰিছে বুলি স্বীকাৰ কৰিছে।</p>
          </td>
        </tr>
        <tr>
          <td colspan="3"></td>
        ...
        <tr>
          <td colspan="3" style="font-size: 7pt; padding-bottom:5px;">
            <h3 class="heading-01">গোটটোৰ ঋণ লওতাসকলে নিশিচতি দিয়ে য়ে:</h3>            
          </td>
        </tr>
        <tr>
          <td colspan="3"></td>
        ...
        <tr>
          <td colspan="3" style="font-size: 6.6pt; padding-bottom:5px;">
            <ol>
              <li>আৰোহণক দিয়া ৰাশি পৰিশোধ কৰাত বিফল হোৱাৰ পৰিস্থিতি এটা ডদ্ভৱ হ'লে, এনে ব্যক্তিৰ(সকলৰ) পৰা দিয়া পৰিমাণ প্রতিহত আৰু / বা প্রাপ্ত কৰাত কেন্দ্রৱে আৰোহণৰ সৈতে সহায় আৰু সহযোগিতা কৰিব</li>
              <li>কেন্দ্রৰ যিকোনো সদস্যই দিয়া ৰাশি পৰিশোধ নকৰাৰ ফলত ডদ্ভৱ হোৱা যিকোনো দায়বদ্ধতা পূৰণ কৰিবলৈ প্রতিশ্রুতি দিছে।</li>
              <li>সীকাৰ কৰে যে, কেন্দ্রৰ ভিতৰত কোনো পৰিশোধ নকৰা স্থিতি হ'লে, গোটটোৰ সকলো সদস্য ভৱিষ্যতে আৰোহণৰ পৰা ঋণ প্রাপ্ত কৰাৰ বাবে অযোগ্য বিবেচিত হ'ব পাৰে।</li>
              <li>আৰু ঋণ লওতাই প্রতিশ্রুতি দিয়ে যে তেওঁ ঋণটো ঋণ আৱেদন প্রপত্র ডল্লেখ কৰা উদ্দেশ্যরে নিজৰ বাবেই ঋণটো লৈছে, আৰু আৰোহণৰ পৰা লোৱা ঋণৰ পৰিমাণটো আনক নিদিয়ে বা অপব্যৱহাৰ নকৰে বুলি প্রতিশ্রুতি দিছে।</li>
        ...
        <tr>
          <td colspan="3" style="font-size: 7pt; padding-bottom:5px;">
            <h3 class="heading-01">লগতে দুযো পক্ষই সীকাৰ কৰিছে যে :</h3>            
          </td>
        </tr>
        <tr>
          <td colspan="3"></td>
        ...
        <tr>
          <td colspan="3" style="font-size: 6.6pt; padding-bottom:5px;">
            <ol>
              <li value="1">1.	ঋণ বিতৰণ কৰা তাৰিখৰ পৰা সূত আদায় কৰা হ'ব আৰু দৈনিক আধাৰত সূত গণনা কৰা হ'ব।</li>
              ...
              <li>ঋণ লওতাই(সকলে) ঋণটো পূর্বসমাপ্ত কৰিব বিচাৰে কোনো জৰিমনা আদায কৰা নহ'ব</li>
              ...
              <li>পলমকৈ কৰা পৰিশোধৰ বাবে কোনো জৰিমনা নালাগে, ঋণ লঁওতাসকলে পলম হোৱাৰ ফলত প্রযোজ্য অতিৰিক্ত সূত পৰিশোধ কৰিব লাগিব।</li>
              ...
              <li>৩০ দিনৰ আগতীয়া জাননী দি ঋণৰ চর্তাৱলী সলনি কৰাৰ অধিকাৰ আৰোহণে সংৰক্ষিত ৰাখিছে।</li>
              <li>ঋণৰ মূল্য হিচাবে গ্রাহকক, মাথোন উভতাব নলগা সূত, ঋণ প্র'ছেচিং আৰু ইঞ্চুৰেঞ্চ প্রিমিয়াম (প্রযোজ্য কৰ সহ) দিব লাগিব।</li>
              <li>আৰোহণে ঋণগ্রহীতাক এমফিন নাইবা স্ব-ধন-ৰ অধীনত একাধিক এনবিএফচি  এমএফআই-ৰ পৰা ঋণ প্রদান নকৰিব।</li>
        ...
        <tr>
          <td colspan="3" style="font-size: 7pt; padding-bottom:5px;">
            <h3 class="heading-01">আৰোহণে ঋণ লঅওঁতাক নিশিচতি দিযে যে:</h3>            
          </td>
        </tr>
        <tr>
          <td colspan="3"></td>
            ...
            <table width="100%" colspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td align="right" colspan="2" style="font-size: 6pt; width:25%">
                      <p> আৰবিআই ৰেজিষ্ট্রেশ্বন নমৰ:  B.05.02932</p>
                    </td>
        ...
        <tr>
          <td align="left" colspan="3" style="font-size: 6pt">
            <p>প্রাথমিক ঋণ গ্রহণ কৰাৰ সময়ত, মই উপযোগী সামগ্রীসমূহৰ তালিকা দেখিছো। সেই অনুযাযী
              মই..............................প্রডাক্ট বাচি লৈছো আৰু আৰোহণক এটাৰ ব্যৱস্থা কৰি দিয়াৰ বাবে অনুৰোধ কৰিছো।
            </p>
          </td>
        </tr>
        <tr>
