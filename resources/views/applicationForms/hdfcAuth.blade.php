...
<head>
    ...
    <title>Hdfc authantication PDF</title>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
                    ...
                    <tr>
                        <td colspan="2" style="padding:3px 0; line-height: 15pt;font-size: 8pt;">
                            This is to inform you that I <span style="border-bottom: 1px dashed #666; width:300px;line-height: 10pt;font-size: 8pt; height: 15pt;display: inline-block;" >{{$detailVal->s_cb_customer_salutation}} {{$detailVal->s_cb_customer_name}}</span> S/O,D/O, W/O
                            <span style="border-bottom: 1px dashed #666; width:410px;line-height: 10pt;font-size: 8pt; height: 15pt;display: inline-block;" >{{($detailVal->s_cb_father_name != '')?$detailVal->s_cb_father_salutation.' '.$detailVal->s_cb_father_name:$detailVal->s_cb_spouse_salutation.' '.$detailVal->s_cb_spouse_name}}</span> have availed a loan from Arohan Financial
                    ...
                    <tr>
                        <td colspan="2">
                            <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
                                <tr>
                                    <td valign="middle" style="padding:2px 0; line-height: 16pt;font-size: 8pt;width: 104px;">Nominee’s Name: </td>
                                    ...
                                    <td valign="middle" align="right" style="padding:2px 5px 2px 0; line-height: 16pt;font-size: 8pt;">Relationship:</td>
                                    <td valign="middle" align="left" style="border:1px solid #000;height:8px; width: 140px; padding-left: 5px;">
                                    ...
                                    <td valign="middle" style="border:1px solid #000;height:8px; width: 70px; padding-left: 5px;">
                                        {{date('d/m/Y', strtotime($detailVal->dt_borrower_dob))}}
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td colspan="2" style="padding: 10px 3px 3px 0px; height: 5px; "><div style="font-style: italic; font-size: 7pt;">(Appointee details to be filled in case Nominee is minor/ *Relationship with Nominee)</div></td>
                    </tr>
                    <tr>
                        <td colspan="2" style="padding: 3px;height: 5px;"></td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
                                <tr>
                                    <td  style="padding:3px 0; line-height: 12pt;font-size: 8pt;">Customer Name: <span style="border-bottom: 1px solid #000; width:150px;line-height: 10pt;font-size: 8pt; height: 15pt;display: inline-block;" >{{$detailVal->s_cb_customer_salutation}} {{$detailVal->s_cb_customer_name}}</span></td>
                                    <td></td>
