...
<!-- Login wrapper -->
<div class="login-wrapper" style="background-image: url({{asset('images/login-bg.jpg')}});">
    <div class="card login-box">
        <div class="card-container align-center">
            ...
            <h1  class="font-lighter">An unexpected error occurred, please refresh and try again.</h1>
