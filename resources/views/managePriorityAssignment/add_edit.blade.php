        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-container clearfix">
                    <h4 class="primary-color">Religion Details</h4>
                    <div class="equal-height-card ">
                        <div class="item-details margin-bottom-sm itemDetails-active">
                            <form method="post" id="frm_add_edit" name="frm_add_edit" action="{{ action('ReligionController@edit') }}" enctype="multipart/form-data">
                                {{csrf_field()}}
                                ...
                                <div class="row ">
                                    <div class="col-la-2 col-me-2 col-sm-6">
                                        <div class="form-panel">
                                            <label>Religion <span class="error-color">*</span></label>
                                            <input type="text" placeholder="Religion" class="input-panel" name="s_religion" value="{!! ($mode == 'Edit') ? $detail->s_religion : '' !!}" >
...
$(document).ready(function(){
    ...
    $("#frm_add_edit button[type=reset]").on('click', function(){
        ...
        form.find('input[name=s_religion]').val(0);
    });
    ...
    $("#frm_add_edit").on('submit', function(){
        ...
        if(dis_form.find("input[name=s_religion]").val() == ""){
            markAsError(dis_form.find("input[name=s_religion]"),'Religion is required!');
            is_valid = false;
        }
