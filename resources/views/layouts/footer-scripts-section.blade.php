...
<script src="{{asset('js/sScreen.js')}}"></script>
<script src="{{asset('components/custom-scrollbar/jquery.mCustomScrollbar.concat.min.js')}}"></script>
<script src="{{asset('js/script.js')}}"></script>
<script src="{{asset('components/datatable/datatables.min.js')}}"></script>
<script src="{{asset('dist/jquery.easy-autocomplete.min.js')}}"></script>
<script src="{{asset('components/timepicker/jquery.ui.position.min.js')}}"></script>
<script src="{{asset('components/timepicker/jquery.ui.timepicker.js')}}"></script>
<script src="{{asset('js/jssor.slider.min.js')}}"></script>

<script src="{{asset('js/autonumeric.js')}}"></script>
<script src="{{asset('js/customjs.js?v=1.10')}}"></script>
...
<script src="{{asset('js/samadhan-custom-v1.js')}}" type="text/javascript"></script>
<script type="text/javascript">
