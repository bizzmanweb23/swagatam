        ...
        <div class="col-la-12">
            <div class="card ">                        
                <div class="card-container">
					...
					<div class="row"> 
						<form class="" id="searchForm" name="frm_search_2" method="POST" action="{{url('taskReports')}}" role="search">
							{{ csrf_field() }}
							...
							<div class="col-la-3 col-me-3 col-sm-6">
								<div class="form-panel">
									...
									<button type="reset" class="button button-gray" onclick="window.location.href='{{url('taskReports')}}'"><i class="material-icons">not_interested</i>Reset</button>
                    ...
                    <div class="table-responsive table-responsive-auto">
                        ...
                        <table class="table-border table-head-color table-odd-even">
                            ...
                            <td class="align-center text-wrap">
                                <?php
                                    $complete_des = ($row->complete_desc != '')? $row->complete_desc : $row->complete_reason;
                                ?>
                                <a href="javascript:void(0);" class="tooltip top-center width-50 icon-button button-primary viewProductDetail" data-tooltip="View" data-info="{{$complete_des}}" onclick="viewDesc(this);"><i class="fas fa-eye"></i></a>
                            </td>
                            ...
                            <td class="align-center text-nowrap">
                                {{ date('d-m-Y g:i A', strtotime($row->submited_date)) }}
                            </td>
                            <td class="align-center text-nowrap"><?php echo getUserName($row->created_by); ?></td>
                            <td class="align-center text-nowrap">
                                <?php echo ($row->completed_date != '0000-00-00 00:00:00')? $row->completed_date : '-'; ?>
                            </td>
                            <td class="align-center text-nowrap">
