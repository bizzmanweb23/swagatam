    ...
    <div class="row">
        <div class="col-la-2 col-me-6 col-sm-6">
            <div class="form-panel">
                ...
                <button type="button" search="2"    class="go-back button button-info"  >
                    Main Page
                </button>
            </div>
        </div>
            ...
            <div class="col-la-12">
                <div class="card ">
                    <div class="card-container">
                        <h4 class="primary-color">Add New Job </h4>
                        <div class="row">
...
{{--                                <input type="hidden" id="h_extension" name="h_extension" value="" />--}}
                                ...
                                <div class="row">
                                    <div class="col-la-4 col-me-3 col-sm-6">
                                        <div class="form-panel">
                                            ...
                                            <div class="form-panel">
                                                <input type="text" name="jobTitle" id="customer_name" placeholder="JOB TITLE" class="input-panel"   autocomplete="off" />
                                    ...
                                    <div class="col-la-4 col-me-3 col-sm-6">
                                        <div class="form-panel">
                                            ...
                                            <div class="form-panel">
                                                <input type="text" name="jobCreatedBy" id="los_application_id" placeholder="JOB CREATED BY" class="input-panel" value="" autocomplete="off" />
                                    ...
                                    <div class="col-la-4 col-me-3 col-sm-6">
                                        <div class="form-panel">
                                            ...
                                            <div class="form-panel">
                                                <input type="text" name="jobUpdatedBy" id="kyc1_id" placeholder="JOB UPDATED BY" class="input-panel" value="" autocomplete="off" />
                                                <span class="error-message"></span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-la-3 col-me-3 col-sm-6">
                                        <div class="form-panel">
                                            ...
                                            <div class="form-panel">
                                                <input type="text" name="jobValidityDate" id="forFromDateSearch" placeholder="Date" class="input-panel" data-role="datepicker2" value="" readonly="true" autocomplete="off" />
                                                <span class="error-message"></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-la-3 col-me-3 col-sm-6">
                                        <div class="form-panel">
                                            ...
                                            <div class="form-panel">
                                                <input type="text" name="jobEffectiveDate" id="forToDateSearch" placeholder="Date" class="input-panel" data-role="datepicker3" value="" readonly="true" autocomplete="off" />
                                                <span class="error-message"></span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-la-1col-me-6 col-sm-6">
                                      <div class="form-panel">
                                          <label for="">Job Description</label>
                                          <input type="text" name="jobDescription" id="customer_name" placeholder="JOB DESCRIPTION" class="input-panel"   autocomplete="off" />
                                          <span class="error-message"></span>
                                      </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-la-2 col-me-6 col-sm-6">
                                        <div class="form-panel">
                                            <label class="hidden-es">&nbsp;</label>
                                            <div class="clearfix"></div>
                                            <button type="button" search="2" id="btn_submit"   class="save-job-btn button button-info"> Submit</button>
                                            <span class="error-message"></span>
                                        </div>
                                    </div>
                                </div>
