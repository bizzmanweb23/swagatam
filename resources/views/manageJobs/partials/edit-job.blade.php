        ...
        <div class="row">
            <div class="col-la-2 col-me-6 col-sm-6">
                <div class="form-panel">
                    ...
                    <button type="submit" search="2" id="go-back"   class="go-back button button-info">
                        Main Page
                    </button>
                </div>
            </div>
            ...
            <div class="col-la-12">
                <div class="card ">
                    <div class="card-container">
                        <h4 class="primary-color">Edit job </h4>
                        <div class="row">
                            <form class="col-sm-12" id="save_job_form" name="frm_search_2"   role="search"  autocomplete="off">
                                 {{ csrf_field() }}
                                @foreach($result as $row)
                                    <input type="hidden" id="h_search" name="id" value="{{ $row->job_id }}" />
                                ...
                                <div class="row">
                                    <div class="col-la-4 col-me-3 col-sm-6">
                                        <div class="form-panel">
                                            ...
                                            <div class="form-panel">
                                                ...
                                                <input type="text" name="jobTitle" id="customer_name" placeholder="JOB TITLE" class="input-panel" value="{{$row->job_title}}"  autocomplete="off" />
                                    ...
                                    <div class="col-la-4 col-me-3 col-sm-6">
                                        <div class="form-panel">
                                            ...
                                            <div class="form-panel">
                                                <input type="text" name="jobCreatedBy" id="los_application_id" placeholder="JOB CREATED BY" class="input-panel" value="{{ $row->job_created_by }}" autocomplete="off" />
                                    ...
                                    <div class="col-la-4 col-me-3 col-sm-6">
                                        <div class="form-panel">
                                            <label>Job Updated By</label>
                                            <div class="form-panel">
                                                <input type="text" name="jobUpdatedBy" id="kyc1_id" placeholder="JOB UPDATED BY" class="input-panel" value="{{ $row->job_updated_by }}" autocomplete="off" />
                                                <span class="error-message"></span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-la-3 col-me-3 col-sm-6">
                                        <div class="form-panel">
                                            <label>Job Validity Date</label>
                                            <div class="form-panel">
                                                <input type="text" name="jobValidityDate" id="forFromDateSearch" placeholder="Date" class="input-panel" data-role="datepicker2" value="{{ $row->job_effective_date }}" readonly="true" autocomplete="off" />
                                                <span class="error-message"></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-la-3 col-me-3 col-sm-6">
                                        <div class="form-panel">
                                            <label>Job Effective Date</label>
                                            <div class="form-panel">
                                                <input type="text" name="jobEffectiveDate" id="forToDateSearch" placeholder="Date" class="input-panel" data-role="datepicker3" value="{{ $row->job_validity_date }}" readonly="true" autocomplete="off" />
                                                <span class="error-message"></span>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-panel">
                                            ...
                                            <div class="form-panel">
                                                <select name="jobZone" id="zoneSearch" class="input-panel chosen-select">
                                                   @foreach($zone as $reg)
                                                   <option value="{{ $reg->s_office_code }}">{{ $reg->s_office_name }}</option>
                                                   @endforeach
                                                </select>
                                                <span class="error-message"></span>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-la-12 col-me-6 col-sm-6">
                                        <div class="form-panel">
                                            ...
                                            <input type="text" name="jobDescription" id="customer_name" placeholder="JOB DESCRIPTION" class="input-panel" value="{{ $row->job_description }}" autocomplete="off" />
                                            <span class="error-message"></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-la-2 col-me-6 col-sm-6">
                                        <div class="form-panel">
                                            <label class="hidden-es">&nbsp;</label>
                                            <div class="clearfix"></div>
                                            <button type="button" search="2" id="btn_submit"   class="save-job-btn button button-info"> Update</button>
                                            <span class="error-message"></span>
                                        </div>
                                    </div>
                                </div>
