...
<div class="wrapper-fluid">
	...
	<div class="row">
		<div class="col-la-12">
			...
			@foreach($data as $row)
				<tr>
				<td class="align-left text-wrap">{{$row->job_code}}</td>
				<td class="align-left text-wrap">{{$row->job_title}}</td>
				<td class="align-left text-wrap">{{$row->job_zone}}</td>
				<td class="align-left text-wrap">{{$row->s_office_name}}</td>
				<td class="align-left text-wrap">{{$row->s_office_name}}</td>
				<td class="align-left text-wrap">{{$row->job_validity_date}}</td>
				<td class="align-left text-wrap">{{$row->job_effective_date}}</td>
				<td class="align-left text-wrap">{{$row->job_created_by}}</td>
				<td class="align-left text-wrap">{{$row->job_updated_by}}</td>
				<td class="align-left text-wrap">{{$row->job_description}}</td>
				...
				<td class="align-center action-tooltip tooltip-width">
                                ...
                                <div class="dropdownList-content">
                                        <a href="{{ route('edit-form',$row->job_id) }}" class="icon-button button-primary" value="{{ $row->job_id }}" id="edit_btn" ><i class="fas fa-edit"></i><span> Edit</span></a>
                                        <a href="javascript:void(0)" class="deletepopup icon-button button-primary" value="{{ $row->job_id }}"><i class="fas fa-trash"></i><span >  Delete</span></a>
                                        <a href="{{ route('view-job',$row->job_id) }}" class="icon-button button-primary" ><i class="fas fa-eye"></i><span> View</span></a>
