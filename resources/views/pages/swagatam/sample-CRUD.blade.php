...
<div class="admin-content-header">
    <h1 class="float-left-sm margin-top-09 primary-color">Manage List</h1>
</div>
        ...
        <div class="col-la-12">
            <div class="card ">
                <div class="card-container">
					...
					<div class="row">
						<form class="col-sm-12" id="searchForm" name="frm_search_2" method="POST" action="" role="search"  autocomplete="off">
							...
							<div class="row">
								<div class="col-la-2 col-me-3 col-sm-6">
									<div class="form-panel">
										<label>Disbursement Date From</label>
										<div class="form-panel">
											<input type="text" name="forFromDateSearch" id="forFromDateSearch" placeholder="Date" class="input-panel" data-role="datepicker2" value="" readonly="true" autocomplete="off" />
								...
								<div class="col-la-2 col-me-3 col-sm-6">
									<div class="form-panel">
										<label>Disbursement Date To</label>
										<div class="form-panel">
											<input type="text" name="forToDateSearch" id="forToDateSearch" placeholder="Date" class="input-panel" data-role="datepicker3" value="" readonly="true" autocomplete="off" />
											<span class="error-message"></span>
										</div>
									</div>
								</div>
								...
								<div class="col-la-2 col-me-3 col-sm-6">
									<div class="form-panel">
										...
										<input type="hidden" name="regionSearched" id="regionSearched" value="">
										<div class="form-panel">
								...
								<div class="col-la-2 col-me-3 col-sm-6">
									<div class="form-panel">
										...
										<input type="hidden" name="branchSearched" id="branchSearched" value="">
										<div class="form-panel">
									...
									<div class="col-la-2 col-me-3 col-sm-6">
										<div class="form-panel">
											...
											<div class="form-panel">
												...
												<option value="Send to Hub">Send To Hub</option>
												<option value="Rejected">CHMS Rejected</option>
									...
									<div class="col-la-2 col-me-3 col-sm-6">
										<div class="form-panel">
											<label for="allStatusSearch">Status</label>
											<div class="form-panel">
												<select name="allStatusSearch" id="allStatusSearch" class="input-panel chosen-select">
												<option value="">-- Select Status --</option>
												<option value="99">LAF Incomplete</option>
												<option value="1">LAF Done</option>
												<option value="2">Neighbour Feedback Done</option>
												<option value="3">Group Formation Done</option>
												<option value="44">CGT 1 Failed</option>
												<option value="4">CGT 1 Done</option>
												<option value="55">CGT 2 Failed</option>
												<option value="5">CGT 2 Done</option>
												<option value="66">Cross Verification Failed</option>
												<option value="6">Cross Verification Done</option>
												<option value="77">GRT Failed</option>
												<option value="7">GRT Done</option>
												<option value="8">Disbursement Done</option>
												<option value="Send to Hub">Send To Hub</option>
												<option value="Rejected">CHMS Rejected</option>
												<option value="Completed">Completed</option>
												</select>
								...
								<div class="col-la-2 col-me-3 col-sm-6">
									<div class="form-panel">
										...
										<div class="form-panel">
											<input type="text" name="arohan_center_name" id="arohan_center_name" placeholder="Center Name" class="input-panel" value="" autocomplete="off" />
											<span class="error-message"></span>
										</div>
									</div>
								</div>
								...
								<div class="col-la-2 col-me-3 col-sm-6">
									<div class="form-panel">
										...
										<div class="form-panel">
											<input type="text" name="groupCode" id="groupCode" placeholder="Group Code" class="input-panel" value="" autocomplete="off" />
											<span class="error-message"></span>
										</div>
									</div>
								</div>
								...
								<div class="col-la-2 col-me-3 col-sm-6">
									<div class="form-panel">
										...
										<div class="form-panel">
											<input type="text" name="arohan_customer_code" id="arohan_customer_code" placeholder="Customer Code" class="input-panel" value="" autocomplete="off" />
											<span class="error-message"></span>
										</div>
									</div>
								</div>
								...
								<div class="col-la-2 col-me-3 col-sm-6">
									<div class="form-panel">
										<label>FIS Customer Code</label>
										<div class="form-panel">
											<input type="text" name="fis_customer_code" id="fis_customer_code" placeholder="FIS Customer Code" class="input-panel" value="" autocomplete="off" />
											<span class="error-message"></span>
										</div>
									</div>
								</div>
								...
								<div class="col-la-2 col-me-3 col-sm-6">
									<div class="form-panel">
										...
										<div class="form-panel">
											<input type="text" name="customer_name" id="customer_name" placeholder="Customer Name" class="input-panel" value="" autocomplete="off" />
											<span class="error-message"></span>
										</div>
									</div>
								</div>
								...
								<div class="col-la-2 col-me-3 col-sm-6">
									<div class="form-panel">
										<label>LOS Application ID</label>
										<div class="form-panel">
											<input type="text" name="los_application_id" id="los_application_id" placeholder="LOS Application ID" class="input-panel" value="" autocomplete="off" />
											<span class="error-message"></span>
										</div>
									</div>
								</div>
								...
								<div class="col-la-2 col-me-3 col-sm-6">
									<div class="form-panel">
										<label>KYC1 ID</label>
										<div class="form-panel">
											<input type="text" name="kyc1_id" id="kyc1_id" placeholder="KYC1 ID" class="input-panel" value="" autocomplete="off" />
											<span class="error-message"></span>
										</div>
									</div>
								</div>
								<div class="col-la-2 col-me-3 col-sm-6">
									<div class="form-panel">
										<label>KYC2 ID</label>
										<div class="form-panel">
											<input type="text" name="kyc2_id" id="kyc2_id" placeholder="KYC2 ID" class="input-panel" value="" autocomplete="off" />
											<span class="error-message"></span>
										</div>
									</div>
								</div>
								<div class="col-la-2 col-me-3 col-sm-6">
									<div class="form-panel">
										<label>FIS Loan ID</label>
										<div class="form-panel">
											<input type="text" name="loanId" id="loanId" placeholder="FIS Loan ID" class="input-panel" value="" autocomplete="off" />
											<span class="error-message"></span>
										</div>
									</div>
								</div>
								<div class="col-la-2 col-me-3 col-sm-6">
									<div class="form-panel">
										...
										<div class="form-panel">
											<input type="text" name="customer_mobile_no" id="customer_mobile_no" placeholder="Mobile No" class="input-panel" value="" autocomplete="off" />
											<span class="error-message"></span>
										</div>
									</div>
								</div>
                    ...
                    <div class="table-responsive">
                        <table class="table-border no-margin table-head-color manage-aircraft-table table-odd-even">
                            <thead>
                                <tr>
                                	<th class="align-center text-nowrap">Loan Type</th>
                                	<th class="align-center text-nowrap">Product Type</th>
                                    <th class="align-center text-nowrap">Activities</th>
    							    <th class="align-center text-nowrap">Action</th>
                                </tr>
                            </thead>
							<tbody>
                            <tr>
								<td class="align-left text-wrap">Individual</td>
								<td class="align-left text-wrap">Bazaar</td>
								<td class="align-left text-wrap">Group Formation , Cross Verification , GRT , LUC , Neighbour feedback done</td>
                            ...
                            <tr>
								<td class="align-left text-wrap">JLG</td>
								<td class="align-left text-wrap">Sca-bazaar</td>
								<td class="align-left text-wrap">LUC , CGT1 , GRT , Cross Verification , Group Formation , Neighbour feedback done</td>
